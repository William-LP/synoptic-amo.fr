...
export interface ApiAccueilAccueil extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Carrousel: Schema.Attribute.Component<'synoptic.carrousel', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email_entreprise: Schema.Attribute.String;
    linkedin_entreprise: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::accueil.accueil'
...
export interface ApiCategorieReferenceCategorieReference
  extends Struct.CollectionTypeSchema {
  collectionName: 'categorie_references';
  info: {
    displayName: 'Cat\u00E9gorie r\u00E9f\u00E9rence';
    pluralName: 'categorie-references';
    singularName: 'categorie-reference';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categorie-reference.categorie-reference'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiMembreMembre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Agence: Schema.Attribute.Relation<'oneToOne', 'api::agence.agence'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Email: Schema.Attribute.Email;
    ...
    Parcours: Schema.Attribute.Component<'synoptic.parcours', true>;
...
export interface ApiMissionMission extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTA_bouton: Schema.Attribute.String;
    CTA_contenu: Schema.Attribute.String;
    CTA_titre: Schema.Attribute.String;
    Etape: Schema.Attribute.Component<'synoptic.etape', true> &
